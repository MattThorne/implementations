...
namespace Microsoft.Quantum.Samples.IntegerFactorization
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            long nTrials = 100;
            bool useRobustPhaseEstimation = false;
            ...
            for (int i = 0; i < nTrials; ++i)
            {
                try
                {
                    ...
                    FactorSemiprimeInteger.Run(estimator, numberToFactor, useRobustPhaseEstimation).Wait();
                    Console.WriteLine(estimator.ToTSV());*/

                    /*
                    QCTraceSimulator sim = new QCTraceSimulator();
                    var res = FactorSemiprimeInteger.Run(sim, numberToFactor, useRobustPhaseEstimation).Result;
